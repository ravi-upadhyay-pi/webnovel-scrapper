    ...
    C: Has<XSpanIdString>  + Clone + Send + Sync + 'static,
{
    ...
    async fn create_authentication_token(
        &self,
        param_user_credential: models::UserCredential,
        context: &C) -> Result<CreateAuthenticationTokenResponse, ApiError>
    {
        ...
        // Body parameter
        let body = serde_json::to_string(&param_user_credential).expect("impossible to fail to serialize");
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(CreateAuthenticationTokenResponse::Status200
                    (body)
                )
            }
            401 => {
                ...
                Ok(CreateAuthenticationTokenResponse::UserExistsOrWeakPassword
                    (body)
                )
            }
            code => {
    ...
    async fn user_delete(
        &self,
        param_get_user_request: models::GetUserRequest,
        context: &C) -> Result<UserDeleteResponse, ApiError>
    {
        let mut client_service = self.client_service.clone();
        let mut uri = format!(
            "{}/user",
        ...
        let body = serde_json::to_string(&param_get_user_request).expect("impossible to fail to serialize");
                *request.body_mut() = Body::from(body);
    ...
    async fn user_get(
        &self,
        param_get_user_request: models::GetUserRequest,
        context: &C) -> Result<UserGetResponse, ApiError>
    {
        let mut client_service = self.client_service.clone();
        let mut uri = format!(
            "{}/user",
    ...
    async fn user_put(
        &self,
        param_user_credential: models::UserCredential,
        context: &C) -> Result<UserPutResponse, ApiError>
    {
        let mut client_service = self.client_service.clone();
        let mut uri = format!(
            "{}/user",
        ...
        match response.status().as_u16() {
            ...
            401 => {
                ...
                Ok(UserPutResponse::UserExistsOrWeakPassword
                    (body)
                )
            }
            code => {
